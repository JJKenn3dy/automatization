...
def create_page8(self) -> QWidget:
    ...
    combobox.setCurrentText("Статус да/нет")
    combobox.addItem("Да")
    ...
    self.input_fio_user.setPlaceholderText("Серийный номер: ")
    ...
    # ФИО пользователя
    self.input_fio_user = QLineEdit(self)
    self.input_fio_user.setPlaceholderText("Серийный номер сертификата: ")
    self.input_fio_user.setMinimumSize(250, 40)
    self.input_fio_user.setStyleSheet('font-size: 15px; color: rgb(98, 150, 30);')
    left_layout.addWidget(self.input_fio_user)
    ...
    combobox = QComboBox(self)
    combobox.setEditable(False)
    combobox.setCurrentText("VIP/ Critical")
    combobox.addItem("Option 1")
    combobox.addItem("Option 2")
    combobox.setMinimumSize(250, 35)
    left_layout.addWidget(combobox)
    ...
    combobox = QComboBox(self)
    combobox.setEditable(True)
    combobox.setCurrentText("Дополнительно")
    combobox.addItem("Option 1")
    combobox.addItem("Option 2")
    combobox.addItem("Option 3")
    combobox.addItem("Option 4")
